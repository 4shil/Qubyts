        ...
        <section id="security" className="section-snap relative min-h-screen py-32 px-6 md:px-12 flex flex-col justify-center">
            <div className="max-w-[1600px] mx-auto w-full">
                <div className="flex flex-col items-end mb-24">
                    <GSAPTextReveal
                        className={`text-[8vw] md:text-[6rem] font-bold tracking-tighter leading-none block text-right bg-clip-text text-transparent bg-gradient-to-br ${isDark
                ...
                <GSAPStaggerCards className="grid grid-cols-1 md:grid-cols-2 gap-6" stagger={0.2}>
