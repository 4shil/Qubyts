            ...
            <div className="max-w-[1600px] mx-auto w-full">
                <div className="mb-24 md:w-2/3">
                    ...
                    <div className="mt-8 max-w-xl">
                        <GSAPWordReveal
                            className={`text-2xl leading-relaxed ${isDark ? 'text-amber-200/60' : 'text-amber-900/60'}`}
                            delay={0.2}
                        >
                ...
                <GSAPStaggerCards className="grid grid-cols-1 md:grid-cols-2 gap-8" stagger={0.2}>
