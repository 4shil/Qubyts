    ...
    return (
        <section id="home" className="section-snap relative h-screen flex flex-col justify-center px-6 md:px-12 overflow-hidden">
            <motion.div style={{ y, opacity }} className="z-10 w-full max-w-[90vw]">
                ...
                {/* Main Title - Brutalist Typography with Parallax */}
                <h1 className={`font-bold tracking-brutal-tight leading-[0.85] mb-8 ${isDark ? 'text-white' : 'text-slate-900'}`}>
                    ...
                    <SplitTextReveal
                        type="words"
                        delay={0.1}
                        className={`text-[14vw] md:text-[10rem] block text-transparent bg-clip-text bg-gradient-to-r text-parallax ${isDark ? 'from-cyan-400 to-purple-500' : 'from-cyan-600 to-purple-600'}`}
                    >
                        BINARY
                    </SplitTextReveal>
                </h1>
                ...
                <div className="flex flex-col md:flex-row gap-8 md:items-end">
                    ...
                    >
                        <MagneticButton
                            voidEffect="explode"
                            className={`px-8 py-4 brutalist-border text-xs font-bold uppercase tracking-widest transition-all cursor-pointer ${isDark
