        ...
        <section id="cloud" className="section-snap relative min-h-screen py-32 px-6 md:px-12 flex flex-col justify-center">
            <div className="max-w-[1600px] mx-auto w-full">
                ...
                <ZoomContainer className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <TiltCard colSpan={2} className={`min-h-[200px] ${isDark ? 'bg-black border-sky-500/50' : 'bg-white border-sky-300'}`}>
                        <div className="p-8">
                    ...
                    <TiltCard colSpan={3} className={`h-48 flex flex-col justify-center items-center ${isDark ? 'bg-black border-white/10' : 'bg-white border-black/10'}`}>
